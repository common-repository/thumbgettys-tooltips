...
class ThumbGettys_OptionsManager {
    ...
    public function getOptionMetaData() {
        return array('app_id' => 'App ID', 'domain' => 'Domain');
    }
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'thumbgettys'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'thumbgettys'); ?></h2>
			
			<div>Get your APP ID and Domain here: <a href="http://www.thumbgettys.com" target="_new">http://www.thumbgettys.com</a></div>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                if ($optionMetaData != null) {
                    foreach ($optionMetaData as $aOptionKey => $aOptionMeta) {
                        ...
                        ?>
                            <tr valign="top">
                                <th scope="row" align="right"><p><label for="<?php echo $aOptionKey ?>"><?php echo $displayText ?></label></p></th>
                                <td>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'thumbgettys') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'thumbgettys');
            case 'false':
                return __('false', 'thumbgettys');

            case 'Administrator':
                return __('Administrator', 'thumbgettys');
            case 'Editor':
                return __('Editor', 'thumbgettys');
            case 'Author':
                return __('Author', 'thumbgettys');
            case 'Contributor':
                return __('Contributor', 'thumbgettys');
            case 'Subscriber':
                return __('Subscriber', 'thumbgettys');
            case 'Anyone':
                return __('Anyone', 'thumbgettys');
        }
        return $optionValue;
    }
